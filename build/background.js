...
/***/ function(module, exports, __webpack_require__) {
	...
	var BADGE_COLOR = [46, 204, 113, 255];
	...
	function sendScreenshot() {
	  chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
	    takeTabScreenShot(function (data) {
	...
	chrome.runtime.onMessage.addListener(createMessageHandler((function () {
	  ...
	  _defineProperty(_createMessageHandler, Message.UPDATE_BADGE, function (msg, sender) {
	  ...
	  _defineProperty(_createMessageHandler, Message.RESET_BADGE, function (msg, sender) {
	    return chrome.browserAction.setBadgeBackgroundColor({ color: [0, 0, 0, 0], tabId: sender.tab.id });
	  });
	
	  _defineProperty(_createMessageHandler, Message.GET_ALL_TABS, function (msg, sender) {
	    return chrome.tabs.query({ currentWindow: true }, function (tabs) {
	      chrome.tabs.sendMessage(sender.tab.id, {
	        action: Message.ALL_TABS,
	        tabUrls: tabs.map(function (t) {
	          return t.url;
	        }) });
	    });
	  });
	
	  _defineProperty(_createMessageHandler, Message.DEFAULT, function (msg, sender) {
	...
	(function init() {
	  if (true) console.info("background init");
	
	  chrome.browserAction.onClicked.addListener(function () {
	    if (true) console.info("background.js browser icon clicked.");
	    sendToggleMsg();
	    //sendScreenshot();
	  });
